void DrawMulPlotsByList_downstream(){
  ...
  c1->cd(3);
  gPad->SetLogy();
  c1->SaveAs("mul_plot_sorted_downstream.pdf[");
  double total_counts = 0;
  for(int ipt=0;ipt<npt;ipt++){
    c1->Clear("D");
    TFile* input = TFile::Open("mul1d_"+list_array[ipt]+"_downstream.root");
  ...
  c2->SaveAs("mul_grand_fit_sorted_downstream.pdf[");
  ...
  pad2->cd();
  ger_reg->SetTitle("Regression: Multiplet Calculated Mean (Downstream Main);;ppb");
  ...
  pad1->Clear();
  pad2->cd();
  ger_lagr->SetTitle("Lagrange: Multiplet Calculated Mean (Downstream Main); ;ppb");
  ...
  pad1->Clear();
  pad2->cd();
  ger_fitted_lagr->SetTitle("Lagrange: Multiplet Fitted Mean (Downstream Main); ;ppb");
  ...
  hsig_fitted_lagr->GetYaxis()->SetTitleSize(0.07);
  hsig_fitted_lagr->GetYaxis()->SetTitleOffset(0.5);
  hsig_fitted_lagr->GetYaxis()->SetLabelSize(0.07);
  hsig_fitted_lagr->GetXaxis()->SetLabelSize(0.13);
