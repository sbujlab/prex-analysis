...
void FitMinirunsByList_downstream(){
  ...
  vector<TString> det_name ={"ds_avg","dsr","dsl"};
  ...
  c1->SaveAs("mini_fit_sorted_downstream.pdf[");
  ...
  for(int ipt=0;ipt<npt;ipt++){
    ...
    ger_reg->SetTitle(list_array[ipt]+": Regression(Downstream Main) ; mini# ; ppb");
    ger_reg->Draw("AP");
    ger_reg->Fit("pol0");
    ...
    ger_lagr->SetTitle(list_array[ipt]+": Lagrange(Downstream Main) ; mini# ; ppb");
    ger_lagr->Draw("AP");
    ger_lagr->Fit("pol0");
  ...
  c2->SaveAs("mini_grand_fit_sorted_downstream.pdf[");
  ...
  pad2->cd();
  ger_reg->SetTitle("Regression: Mini-run Weighted Average (downstream Main);;ppb");
  ger_reg->SetMarkerStyle(20);
  ger_reg->Draw("AP");
  ger_reg->Fit("pol0");
  ...
  pad2->cd();
  ger_lagr->SetTitle("Lagrange:  Mini-run Weighted Average (downstream Main);;ppb");
  ger_lagr->SetMarkerStyle(20);
  ger_lagr->Draw("AP");
  ger_lagr->Fit("pol0");
