void ShowSeeSaw(Int_t run_number=3426,
			     TString user_cut=""){
  ...
  c1->Divide(2,1);
  c1->cd(1);
  mul->Draw("reg_asym_usl/ppm:yield_bmod_ramp",
  ...
  c1->cd(2);
  mul->Draw("(actual_pattern_polarity-0.5)*2*reg_asym_usl/ppm:yield_bmod_ramp",
	    "ErrorFlag==0x4019000 && yield_bmwobj==5","");
  ...
  c2->Divide(2,1);
  c2->cd(1);
  mul->Draw("reg_asym_usr/ppm:yield_bmod_ramp",
	    "ErrorFlag==0x4019000 && yield_bmwobj==5","*");
  ...
  c2->cd(2);
  mul->Draw("(actual_pattern_polarity-0.5)*2*reg_asym_usr/ppm:yield_bmod_ramp",
	    "ErrorFlag==0x4019000 && yield_bmwobj==5","");
  ...
  c3->Divide(2,1);
  c3->cd(1);
  mul->Draw("reg_asym_us_dd/ppm:yield_bmod_ramp",
	    "ErrorFlag==0x4019000 && yield_bmwobj==5","*");
  ...
  c3->cd(2);
  mul->Draw("(actual_pattern_polarity-0.5)*2*reg_asym_us_dd/ppm:yield_bmod_ramp",
	    "ErrorFlag==0x4019000 && yield_bmwobj==5","");
