...
void Add_RCDB_from_Agg_parts(){ //(int start, int end)
  ...
  TTree *agg_tree;
  TTree *mini_tree;
  TTree *eig_reg_tree_part_avg;
  TTree *eig_reg_tree_reference;
  TTree *eig_reg_tree_reference_tr;
  agg_input.GetObject("agg", agg_tree);
  eig_input.GetObject("mini", mini_tree);
  eig_input.GetObject("mini_eigen_reg_5bpms_part_avg", eig_reg_tree_part_avg);
  eig_input.GetObject("mini_reference_eigen_reg_5bpms", eig_reg_tree_reference);
  eig_input.GetObject("mini_reference_eigen_reg_5bpms_tr", eig_reg_tree_reference_tr);

  TChain* out_mini_tree           = (TChain*)mini_tree           -> CloneTree(0);
  TChain* out_eig_reg_tree_part_avg    = (TChain*)eig_reg_tree_part_avg    -> CloneTree(0);
  TChain* out_eig_reg_tree_reference      = (TChain*)eig_reg_tree_reference      -> CloneTree(0);
  TChain* out_eig_reg_tree_reference_tr   = (TChain*)eig_reg_tree_reference_tr   -> CloneTree(0);
  ...
  for(int ievt=0;ievt<nEntries;ievt++){
    ...
    eig_reg_tree_part_avg    -> GetEntry(ievt);
    eig_reg_tree_reference      -> GetEntry(ievt);
    eig_reg_tree_reference_tr   -> GetEntry(ievt);
    ...
    out_mini_tree           -> Fill();
    out_eig_reg_tree_part_avg    -> Fill();
    out_eig_reg_tree_reference      -> Fill();
    out_eig_reg_tree_reference_tr   -> Fill();
  }

  //output.cd();
  out_mini_tree           -> Write("mini",TObject::kOverwrite);
  out_eig_reg_tree_part_avg    -> Write("mini_eigen_reg_5bpms_part_avg",TObject::kOverwrite);
  out_eig_reg_tree_reference      -> Write("mini_reference_eigen_reg_5bpms",TObject::kOverwrite);
  out_eig_reg_tree_reference_tr   -> Write("mini_reference_eigen_reg_5bpms_tr",TObject::kOverwrite);
  //output.Close();
  //delete output;
  //delete agg_tree;
  //delete mini_tree;
  //delete eig_reg_tree_part_avg;
  //delete eig_reg_tree_reference;
  //delete eig_reg_tree_reference_tr;
}
