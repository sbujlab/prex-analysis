void DrawEigenVectors_allslug_updown(){
  gStyle->SetOptStat(0);
  ...
  TFile *input = TFile::Open("./rootfiles/all_slugs_updown.root");
  TTree *eig_tree;
  ...
  c2->Print("eigenvector_updown.pdf[");
  ...
  c2->Print("eigenvalue_updown.pdf");
